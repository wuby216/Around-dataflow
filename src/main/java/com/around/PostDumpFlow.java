...
public class PostDumpFlow {
   ...
   private static final String PROJECT_ID = "first-geode-236002";
   ...
   public static void main(String[] args) {
       ...
       PCollection<Result> btRows = p.apply(Read.from(CloudBigtableIO.read(config)));   // Pcollection can support large amount of data
       PCollection<TableRow> bqRows = btRows.apply(ParDo.of(new DoFn<Result, TableRow>() {  // convert to TableRow type
           @Override
